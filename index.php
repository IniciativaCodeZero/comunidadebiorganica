...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="imagens/cursos.jpg" alt="cursos" style="width: 90%; height: 400px;" />
      ...
      <div class="item">
        <img src="imagens/projetos.jpg" alt="projetos" style="width: 90%; height: 400px;" />
        <div class="carousel-caption">
      ...
      <div class="item">
        <img src="imagens/eventos.jpg" alt="eventos" style="width: 90%; height: 400px;" />
        <div class="carousel-caption">
